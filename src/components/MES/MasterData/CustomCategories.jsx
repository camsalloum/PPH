...
import FormulationsTab from './FormulationEditor';
                              ...
                              return (
                                <div key={group.catlinedesc}>
                                  ...
                                  >
                                    ...
                                    {group.formulation_count > 0 && (
                                      <div style={{ marginTop: 6, fontSize: 11, color: '#7c3aed' }}>
                                        📋 {group.formulation_count} formulation{group.formulation_count !== 1 ? 's' : ''}
                                        {group.active_formulation_count > 0 ? ` (${group.active_formulation_count} active)` : ''}
                                      </div>
                                    )}
                                  </div>
                                </div>
                ...
                ...(igDetail?.scope_type === 'category_group' ? [
                  {
                    ...
                    children: (
                      <FormulationsTab
                        catId={igDetail.category?.id}
                        catlinedesc={igDetail.catlinedesc}
                        materialClass={igDetail.category?.material_class}
                        headers={headers}
