/**
 * Drop and recreate sync functions with correct types
 */
...
async function run() {
  ...
  try {
    ...
    await client.query(`
      ...
      DROP FUNCTION IF EXISTS rebuild_unified_data();
      DROP FUNCTION IF EXISTS sync_new_customers_to_unified();
      DROP FUNCTION IF EXISTS sync_new_sales_reps_to_unified();
      DROP FUNCTION IF EXISTS sync_new_product_groups_to_unified();
    `);
    ...
    console.log('Or use the API: POST /api/unified/sync\n');
