...
const UAEDirhamSymbol = ({ className = '', style = {} }) => {
  // Default styles that scale with text size using em units
  // This ensures consistent sizing with other currency symbols
  const defaultStyle = {
    display: 'inline-block',
    verticalAlign: '-0.125em', // Slightly adjusted for better alignment
    width: '0.95em',  // Slightly smaller to match typical currency symbol width
    height: '0.95em', // Maintains aspect ratio
    marginRight: '0.15em', // Consistent spacing with text symbols
